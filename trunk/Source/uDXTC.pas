{: uDXTC<p>
   ...
   Adapted from GLScene projects (http://glscene.org)<p>
}
unit uDXTC;
...
uses
   SysUtils, OpenGL1x, GLTextureFormat;
...
begin
      ...
      case DX9header.SurfaceFormat.ddpf.dwFourCC of
        FOURCC_DXT1:
          begin
            ...
            tFormat := tfCOMPRESSED_RGBA_S3TC_DXT1;
        ...
        FOURCC_DXT2, FOURCC_DXT3:
          begin
            ...
            tFormat := tfCOMPRESSED_RGBA_S3TC_DXT3;
        ...
        FOURCC_DXT4, FOURCC_DXT5:
          begin
            ...
            tFormat := tfCOMPRESSED_RGBA_S3TC_DXT5;
        ...
        FOURCC_ATI1:
          begin
            ...
            tFormat := tfCOMPRESSED_RED_RGTC1;
        ...
        8: begin
          for i := 0 to High(cImageDataFormat8bits) do
            ...
            begin
              ...
              tFormat := cImageDataFormat8bits[i].TexFormat;
        ...
        16: begin
          for i := 0 to High(cImageDataFormat16bits) do
            ...
            begin
              ...
              tFormat := cImageDataFormat16bits[i].TexFormat;
        ...
        24: begin
          for i := 0 to High(cImageDataFormat24bits) do
            ...
            begin
              ...
              tFormat := cImageDataFormat24bits[i].TexFormat;
        ...
        32: begin
          for i := 0 to High(cImageDataFormat32bits) do
            ...
            begin
              ...
              tFormat := cImageDataFormat32bits[i].TexFormat;
  ...
  iFormat:=InternalFormatToOpenGLFormat(tFormat);
end;
