{: uTextures - Модуль для работы с текстурами OpenGL
	...
	Historique:
        13/09/12 - Fantom - Добавлено свойство CompareMode для текстуры глубины
  ...
  23/03/11 - Fantom - Добавлено свойство TwoSides + импорт из сценовской текстуры
        21/08/10 - Fantom - Добавлен прямой доступ к установкам мипмаппинга,
                            фильтров, враппинга и смешивания.
  19/08/10 - Fantom - Добавлен класс для работы с библиотекой текстур
